...
class IconsCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //delegate?.didSelectIcon(image: icon)
    }
    
    public var listener : ((_ image:UIImage)->Void)?
    
    //public var delegate: IconCollectionViewDelegate?
    // MARK: UICollectionViewDelegate
}
//public protocol IconCollectionViewDelegate{
